...
@pytest.mark.parametrize("cumulative_bound", [0.75])
def test_price_duality(test_mp, cumulative_bound):
    years = [2020, 2025, 2030, 2040, 2050]

    # ---------------------------------------
    # Run scenario with cumulative constraint
    # ---------------------------------------
    ...
    npt.assert_allclose(emiss, emiss_tax, rtol=.05)
